  ...
  <div class ="receptacle-background">
    ...
    <div class = "receptacle-init">
      <div class = "rec-init-1">
        <form accept-charset="utf-8" action = "admin_change_credentials.php?ibgs=4554&clt=<?php echo $client_id?>" class = "client_form" method = "post" autocomplete="off"> <!--*****-->
          <div class = "receptacle-title">
            <h2>Change Password of client bank account</h2>
          </div>
          ...
          <div class= "rec-init">
              ...
              <input name="new-pwd" size="35" maxlength="35" type="password" required>
          </div>

          <div  class= "rec-init">
              <label>Re-enter new password : </label><br>
              <input name="new-pwd-2" size="35" maxlength="35" type="password" required>
          </div>
