  ...
  <div class = "receptacle-background">
    <div class = "receptacle-init" >
      <div class = "rec-init">
        ...
        <p id = "contact-details">Individual Project<br>Project Y Bank<br>Birmingham,
      ...
      <div class = "rec-init">
        ...
        <p id = "contact-details">Email: projectY@projectY.com<br>Fax: 851-846-874-3654<br>
      ...
      <div id = "move" class = "rec-init">
        ...
        <p id = "contact-details">Email: ProjY.customerservice@projectY.com<br>Fax: 853-846-874-3654<br>
