  ...
  <div class ="receptacle-background">
    ...
    <div class = "receptacle-init">
      <div class = "rec-init-1">
        <form accept-charset="utf-8" action = "admin_change_credentials.php?ibgs=9734&clt=<?php echo $client_id?>" accept-charset="utf-8" class = "client_form" method = "post" autocomplete="off">
          <div class = "receptacle-title">
            <h2>Change PIN of client bank account</h2>
          </div>

          <div class=rec-init>
              <label>Enter your admin password : </label><br>
              <input name="admin-pwd" size="35" maxlength="35" type="password" required>
          </div>
          <div class= "rec-init">
              <label>Enter new PIN : </label><br>
              <input name="new-pin" size="10" maxlength="10" type="password" required>
          </div>

          <div  class= "rec-init">
              <label>Re-enter new PIN : </label><br>
              <input name="new-pin-2" size="10" maxlength="10" type="password" required>
          </div>
